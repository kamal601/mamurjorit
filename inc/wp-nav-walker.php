...
if ( ! class_exists( 'crossfits_nav_walker' ) ) {
	 ...
	 */
	class Mamurjorit_Walker_Nav_Menu extends Walker_Nav_Menu {
		/**
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			 ...
			 *
			 * @param string   $menu_id The ID that is applied to the menu item's `<li>` elemen t.
			...
			if ( ! empty( $icon_class_string ) ) {
				...
				$icon_html = '<i class="' . esc_attr( $icon_class_string ) . '" aria-hidden="true"></i><span> ';
			}
