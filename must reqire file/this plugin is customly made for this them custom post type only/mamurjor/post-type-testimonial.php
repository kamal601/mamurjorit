...
function testimonial_post() {
	$labels = array(
		'name'               => _x( 'testimonial', 'post type general name', 'mamurjorit' ),
		'singular_name'      => _x( 'testimonial', 'post type singular name', 'mamurjorit' ),
		'menu_name'          => _x( 'Mamurjor IT testimonial', 'admin menu', 'mamurjorit' ),
		'name_admin_bar'     => _x( 'testimonial', 'add new on admin bar', 'mamurjorit' ),
		'add_new'            => _x( 'Add New', 'testimonial', 'mamurjorit' ),
		'add_new_item'       => __( 'Add New testimonial', 'mamurjorit' ),
		'new_item'           => __( 'New testimonial', 'mamurjorit' ),
		'edit_item'          => __( 'Edit testimonial', 'mamurjorit' ),
		'view_item'          => __( 'View testimonial', 'mamurjorit' ),
		'all_items'          => __( 'All testimonial', 'mamurjorit' ),
		'search_items'       => __( 'Search testimonial', 'mamurjorit' ),
		'parent_item_colon'  => __( 'Parent testimonial:', 'mamurjorit' ),
		'not_found'          => __( 'No testimonial found.', 'mamurjorit' ),
		'not_found_in_trash' => __( 'No testimonial found in Trash.', 'mamurjorit' )
	);
